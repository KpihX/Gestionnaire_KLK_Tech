# -*-coding:UTF-8 -*
from Manager_Functions_cmd import*
import shutil

if paw("KLK-Tech") == True:
    Products = []
    try:
        openBinaryFile(Products, "Products")
        assert Products != []
    except:
        pass
    Customers = {}
    try:
        openBinaryFile(Customers, "Customers")
    except:
        pass
        ...
        if choice == '3':
            while True:
                ...
                try:
                    ...
                    print(f"Le client {Del} n'est pas dans notre liste des clients.")
    ...
    openBinaryFile(Products, "Products", "wb")      
    openBinaryFile(Customers, "Customers", "wb") 
